...
1.-Pedir al usuario una ruta de una carpeta con imput
2.-Repasar toda sla scarpetas y subcarpetas y archivos dentro  de esa carpeta
3.-Para cada archivo o carpeta quiero comprimir en un zip.
4.-Una vez comprimido el zip quiero eliminar los conbtenidos originales.

IA: Quiero que en base a estos programa scon la misma sintaxis y bases que ya tienen me crees uno que tenga:
'''
